<?php
      ...
      if($resultCheck<1)//if no rows selected
      {
       ...
       echo "<script type='text/javascript'>window.open('teacher.php','_self')</script>";
        exit();
      }
      else
      {
...
<body>
  ...
  <div class ="loginbox">
    ...
    <hr>
<br>
    <form action="teacher.php" method="post" id="form">
      <p>Email</p>
       <input type="text" name="email" placeholder="Enter your Email to login" id="loginEmail" value="<?php echo $_COOKIE['email'];?>">
