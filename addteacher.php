<?php
session_start();
        $eerr = $perr = $cperr = $fnerr =  " ";
        $email = $passwd = $fname = $lname ="";
        ...
        if($boolen){
         ...
         mysqli_select_db($con,"attedance");
          ...
          if (mysqli_query($con, $sql)) {
           ...
           function NewUser(){
                $sql = "INSERT INTO teacher (email,firstname,lastname,password,Gender,Contact) VALUES ('$_POST[email]','$_POST[fname]','$_POST[lname]','$_POST[passwd]','NULL','NULL')";
...
<fieldset>
  <div class ="loginbox">
     <h1 class="hone" >Add teacher's info here</h1>
     <hr>
     <br>
