...
<div class="profile" >
	...
	<form method="post" action="processProfileUpdate.php" style="float: right;">
	  ...
	  <h6 style="font-family: 'Antic';color: red;">The fields marked with * must be filled</h6>
  	  <p>Roll Number <b style="color:red;">*</b></p>
  	  <input type="text" value= "<?php echo htmlspecialchars($uname); ?>" name="username" class="grad"><br>
  	  <p>First Name </p>
  	  ...
  	  <p>Email</p>
  	  <input type="text" value="<?php echo htmlspecialchars($em); ?>" name="email"><br>
  	  <p>Gender</p>
